...
item replace entity @e[type=player,tag=respawned] armor.feet with minecraft:leather_boots{Enchantments:[{id:"minecraft:depth_strider", lvl: 3}, {id:"minecraft:vanishing_curse",lvl:1}], AttributeModifiers: [{Name:"generic.movement_speed",AttributeName:"generic.movement_speed",Operation:2,Amount:0.4,Slot:"feet",UUID:[I;1498693494,1027158888,1898994005,860320107]}]}
