/*
召唤末地传送门的方法：
- 末影之眼右键点击泥土，检查该区块是否为末地传送门区块（概率 1/40，如果是，则泥土变为空刷怪笼）
- 找到区块后，向下挖掘到深板岩区，末影之眼右键点击深板岩生成传送门房间。
- 房间内将随机生成 6 个强化深板岩，用末影之眼点击其中某一个将生成末地传送门框架（每个框架有 1/10 概率包含眼）。
- 填充框架完成末地传送门。
除填充步骤外，末影之眼每次使用都会有 4% 概率损坏，即使没有点击到有效方块也会触发。
警告：最后生成的末地传送门框架包含下方的熔岩池，注意安全！
*/
